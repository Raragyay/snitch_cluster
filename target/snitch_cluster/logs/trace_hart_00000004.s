#; unknown function (??:0)
#; 
             25000    0x00001000 csrr    a0, mhartid            #; mhartid = 4, (wrb) a0  <-- 4
             49000    0x00001004 auipc   a1, 0x0                #; (wrb) a1  <-- 4100
             73000    0x00001008 addi    a1, a1, 32             #; a1  = 4100, (wrb) a1  <-- 4132
             97000    0x0000100c auipc   t0, 0x0                #; (wrb) t0  <-- 4108
            121000    0x00001010 lw      t0, 20(t0)             #; t0  = 4108, t0  <~~ Word[0x00001020]
            142000                                              #; (lsu) t0  <-- 0x80000000
            145000    0x00001014 jalr    t0                     #; t0  = 0x80000000, (wrb) ra  <-- 4120, goto 0x80000000
...
#;   mul  t0, t1, t0
            264000    0x80000120 mul     t0, t1, t0             #; t1  = 0, t0  = 0
            282000                                              #; (acc) a0  <-- 4
            296000                                              #; (acc) t0  <-- 0
#; unknown function (start.S:111)
#;   add  a2, a2, t0
            297000    0x80000124 add     a2, a2, t0             #; a2  = 0x10000000, t0  = 0, (wrb) a2  <-- 0x10000000
#; unknown function (start.S:114)
#;   li   t0, SNRT_TCDM_SIZE
            298000    0x80000128 lui     t0, 0x20               #; (wrb) t0  <-- 0x00020000
#; unknown function (start.S:115)
#;   add  a2, a2, t0
            299000    0x8000012c add     a2, a2, t0             #; a2  = 0x10000000, t0  = 0x00020000, (wrb) a2  <-- 0x10020000
#; unknown function (start.S:121)
#;   la        t0, __cdata_end
            300000    0x80000130 auipc   t0, 0x7                #; (wrb) t0  <-- 0x80007130
            301000    0x80000134 addi    t0, t0, -1176          #; t0  = 0x80007130, (wrb) t0  <-- 0x80006c98
#; unknown function (start.S:122)
#;   la        t1, __cdata_start
            302000    0x80000138 auipc   t1, 0x7                #; (wrb) t1  <-- 0x80007138
            303000    0x8000013c addi    t1, t1, -1184          #; t1  = 0x80007138, (wrb) t1  <-- 0x80006c98
#; unknown function (start.S:123)
#;   sub       t0, t0, t1
            304000    0x80000140 sub     t0, t0, t1             #; t0  = 0x80006c98, t1  = 0x80006c98, (wrb) t0  <-- 0
#; unknown function (start.S:124)
#;   sub       a2, a2, t0
            305000    0x80000144 sub     a2, a2, t0             #; a2  = 0x10020000, t0  = 0, (wrb) a2  <-- 0x10020000
#; unknown function (start.S:125)
#;   la        t0, __cbss_end
            306000    0x80000148 auipc   t0, 0x7                #; (wrb) t0  <-- 0x80007148
            307000    0x8000014c addi    t0, t0, -1184          #; t0  = 0x80007148, (wrb) t0  <-- 0x80006ca8
#; unknown function (start.S:126)
#;   la        t1, __cbss_start
            308000    0x80000150 auipc   t1, 0x7                #; (wrb) t1  <-- 0x80007150
            309000    0x80000154 addi    t1, t1, -1208          #; t1  = 0x80007150, (wrb) t1  <-- 0x80006c98
#; unknown function (start.S:127)
#;   sub       t0, t0, t1
            310000    0x80000158 sub     t0, t0, t1             #; t0  = 0x80006ca8, t1  = 0x80006c98, (wrb) t0  <-- 16
#; unknown function (start.S:128)
#;   sub       a2, a2, t0
            311000    0x8000015c sub     a2, a2, t0             #; a2  = 0x10020000, t0  = 16, (wrb) a2  <-- 0x1001fff0
...
#;   sll       t0, a0, SNRT_LOG2_STACK_SIZE
            314000    0x80000168 slli    t0, a0, 10             #; a0  = 4, (wrb) t0  <-- 4096
#; unknown function (start.S:143)
#;   sub       sp, a2, t0
            315000    0x8000016c sub     sp, a2, t0             #; a2  = 0x1001ffe8, t0  = 4096, (wrb) sp  <-- 0x1001efe8
...
#;   slli      t0, a0, 3  # this hart
            318000    0x80000178 slli    t0, a0, 3              #; a0  = 4, (wrb) t0  <-- 32
#; unknown function (start.S:152)
#;   slli      t1, a1, 3  # all harts
            319000    0x8000017c slli    t1, a1, 3              #; a1  = 9, (wrb) t1  <-- 72
#; unknown function (start.S:153)
#;   sub       sp, sp, t0
            324000    0x80000180 sub     sp, sp, t0             #; sp  = 0x1001efe8, t0  = 32, (wrb) sp  <-- 0x1001efc8
...
#;   sub       sp, sp, t0
            331000    0x8000019c sub     sp, sp, t0             #; sp  = 0x1001efc8, t0  = 0, (wrb) sp  <-- 0x1001efc8
...
#;   sub       sp, sp, t0
            341000    0x800001b4 sub     sp, sp, t0             #; sp  = 0x1001efc8, t0  = 16, (wrb) sp  <-- 0x1001efb8
#; unknown function (start.S:168)
#;   andi      sp, sp, ~0x7 # align to 8B
            342000    0x800001b8 andi    sp, sp, -8             #; sp  = 0x1001efb8, (wrb) sp  <-- 0x1001efb8
#; unknown function (start.S:170)
#;   mv        tp, sp
            343000    0x800001bc mv      tp, sp                 #; sp  = 0x1001efb8, (wrb) tp  <-- 0x1001efb8
#; unknown function (start.S:172)
#;   andi      sp, sp, ~0x7 # align stack to 8B
            348000    0x800001c0 andi    sp, sp, -8             #; sp  = 0x1001efb8, (wrb) sp  <-- 0x1001efb8
...
#;   void snrt_main() {
            362000    0x80005ea8 addi    sp, sp, -32            #; sp  = 0x1001efb8, (wrb) sp  <-- 0x1001ef98
#; snrt_main (start.c:-1)
#; 
            363000    0x80005eac sw      ra, 28(sp)             #; sp  = 0x1001ef98, 0x800001cc ~~> Word[0x1001efb4]
            364000    0x80005eb0 sw      s0, 24(sp)             #; sp  = 0x1001ef98, 0 ~~> Word[0x1001efb0]
            365000    0x80005eb4 sw      s1, 20(sp)             #; sp  = 0x1001ef98, 0 ~~> Word[0x1001efac]
            366000    0x80005eb8 sw      s2, 16(sp)             #; sp  = 0x1001ef98, 0 ~~> Word[0x1001efa8]
...
#;               asm("csrr %0, mhartid" : "=r"(hartid));
            367000    0x80005ebc csrr    s2, mhartid            #; mhartid = 4, (wrb) s2  <-- 4
#; snrt_main (start.c:114)
#;   snrt_init_tls (start.c:29)
#;     snrt_is_dm_core (team.h:57)
#;       snrt_is_compute_core (team.h:53)
...
#;           return snrt_global_core_idx() % snrt_cluster_core_num();
            376000    0x80005ec8 mulhu   a0, s2, a0             #; s2  = 4, a0  = 0x38e38e39
            384000                                              #; (acc) a0  <-- 0
            385000    0x80005ecc srli    a0, a0, 1              #; a0  = 0, (wrb) a0  <-- 0
            386000    0x80005ed0 slli    a1, a0, 3              #; a0  = 0, (wrb) a1  <-- 0
            387000    0x80005ed4 add     a0, a1, a0             #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
            388000    0x80005ed8 sub     a5, s2, a0             #; s2  = 4, a0  = 0, (wrb) a5  <-- 4
            389000    0x80005edc li      a6, 8                  #; (wrb) a6  <-- 8
#; snrt_main (start.c:114)
#;   snrt_init_tls (start.c:29)
#;     if (snrt_is_dm_core()) {
            390000    0x80005ee0 bltu    a5, a6, pc + 524       #; a5  = 4, a6  = 8, taken, goto 0x800060ec
#; snrt_main (start.c:114)
...
#; 
            744000    0x800060f0 sltiu   a7, a5, 8              #; a5  = 4, (wrb) a7  <-- 1
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     if (snrt_cluster_idx() == 0 && snrt_is_dm_core()) {
            745000    0x800060f4 bltu    a6, s2, pc + 96        #; a6  = 8, s2  = 4, not taken
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     snrt_is_dm_core (team.h:57)
#;       snrt_is_compute_core (team.h:53)
#;         snrt_cluster_core_idx (team.h:41)
#;           return snrt_global_core_idx() % snrt_cluster_core_num();
            746000    0x800060f8 andi    a0, s2, 255            #; s2  = 4, (wrb) a0  <-- 4
            747000    0x800060fc lui     a1, 0x38e39            #; (wrb) a1  <-- 0x38e39000
            748000    0x80006100 addi    a1, a1, -455           #; a1  = 0x38e39000, (wrb) a1  <-- 0x38e38e39
            749000    0x80006104 mulhu   a1, a0, a1             #; a0  = 4, a1  = 0x38e38e39
            758000                                              #; (acc) a1  <-- 0
            759000    0x80006108 srli    a1, a1, 1              #; a1  = 0, (wrb) a1  <-- 0
            760000    0x8000610c slli    a2, a1, 3              #; a1  = 0, (wrb) a2  <-- 0
            761000    0x80006110 add     a1, a2, a1             #; a2  = 0, a1  = 0, (wrb) a1  <-- 0
            762000    0x80006114 sub     a0, a0, a1             #; a0  = 4, a1  = 0, (wrb) a0  <-- 4
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     snrt_is_dm_core (team.h:57)
#;       snrt_is_compute_core (team.h:53)
#;         return snrt_cluster_core_idx() < snrt_cluster_compute_core_num();
            763000    0x80006118 sltiu   a1, a0, 8              #; a0  = 4, (wrb) a1  <-- 1
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     if (snrt_cluster_idx() == 0 && snrt_is_dm_core()) {
            764000    0x8000611c auipc   a0, 0x1                #; (wrb) a0  <-- 0x8000711c
            765000    0x80006120 addi    a0, a0, -292           #; a0  = 0x8000711c, (wrb) a0  <-- 0x80006ff8
            766000    0x80006124 auipc   a2, 0x1                #; (wrb) a2  <-- 0x80007124
            767000    0x80006128 addi    a2, a2, 512            #; a2  = 0x80007124, (wrb) a2  <-- 0x80007324
            768000    0x8000612c sub     a4, a2, a0             #; a2  = 0x80007324, a0  = 0x80006ff8, (wrb) a4  <-- 812
            769000    0x80006130 seqz    a2, a4                 #; a4  = 812, (wrb) a2  <-- 0
            770000    0x80006134 or      a1, a1, a2             #; a1  = 1, a2  = 0, (wrb) a1  <-- 1
            771000    0x80006138 bnez    a1, pc + 28            #; a1  = 1, taken, goto 0x80006154
...
#;     _cls_ptr = (cls_t*)snrt_cls_base_addr();
            ...
            799000    0x8000618c add     a2, a2, tp             #; a2  = 0, tp  = 0x1001efb8, (wrb) a2  <-- 0x1001efb8
            800000    0x80006190 sw      a1, 0(a2)              #; a2  = 0x1001efb8, 0x1001fff0 ~~> Word[0x1001efb8]
#; snrt_main (start.c:130)
...
#; main (main.c:9)
#;   int main() {
            911000    0x80002084 addi    sp, sp, -48            #; sp  = 0x1001ef98, (wrb) sp  <-- 0x1001ef68
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:-1)
#; 
            912000    0x80002088 sw      s0, 44(sp)             #; sp  = 0x1001ef68, 0x80006ca8 ~~> Word[0x1001ef94]
            913000    0x8000208c sw      s1, 40(sp)             #; sp  = 0x1001ef68, 0x80006c98 ~~> Word[0x1001ef90]
            914000    0x80002090 sw      s2, 36(sp)             #; sp  = 0x1001ef68, 4 ~~> Word[0x1001ef8c]
            915000    0x80002094 sw      s3, 32(sp)             #; sp  = 0x1001ef68, 0 ~~> Word[0x1001ef88]
            916000    0x80002098 sw      s4, 28(sp)             #; sp  = 0x1001ef68, 0 ~~> Word[0x1001ef84]
            917000    0x8000209c sw      s5, 24(sp)             #; sp  = 0x1001ef68, 0 ~~> Word[0x1001ef80]
            923000    0x800020a0 sw      s6, 20(sp)             #; sp  = 0x1001ef68, 0 ~~> Word[0x1001ef7c]
            924000    0x800020a4 sw      s7, 16(sp)             #; sp  = 0x1001ef68, 0 ~~> Word[0x1001ef78]
            925000    0x800020a8 sw      s8, 12(sp)             #; sp  = 0x1001ef68, 0 ~~> Word[0x1001ef74]
#; main (main.c:10)
...
#;         snrt_hartid (team.h:7)
#;           asm("csrr %0, mhartid" : "=r"(hartid));
            926000    0x800020ac csrr    t2, mhartid            #; mhartid = 4, (wrb) t2  <-- 4
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:815)
#;     snrt_cluster_core_idx (team.h:41)
#;       snrt_global_core_idx (team.h:28)
...
#;     snrt_cluster_core_idx (team.h:41)
#;       return snrt_global_core_idx() % snrt_cluster_core_num();
            929000    0x800020b8 mulhu   a0, t2, a0             #; t2  = 4, a0  = 0x38e38e39
            939000                                              #; (acc) a0  <-- 0
            940000    0x800020bc srli    a0, a0, 1              #; a0  = 0, (wrb) a0  <-- 0
            941000    0x800020c0 slli    a1, a0, 3              #; a0  = 0, (wrb) a1  <-- 0
            942000    0x800020c4 add     a0, a1, a0             #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
#; main (main.c:10)
#;   batchnorm_backward_training (team.h:-1)
#; 
            943000    0x800020c8 auipc   t3, 0x5                #; (wrb) t3  <-- 0x800070c8
            944000    0x800020cc addi    t3, t3, -360           #; t3  = 0x800070c8, (wrb) t3  <-- 0x80006f60
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:819)
#;     uint32_t H = l->IH;
            945000    0x800020d0 lw      a7, 4(t3)              #; t3  = 0x80006f60, a7  <~~ Word[0x80006f64]
            990000                                              #; (lsu) a7  <-- 2
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:820)
#;     uint32_t W = l->IW;
            991000    0x800020d4 lw      t0, 8(t3)              #; t3  = 0x80006f60, t0  <~~ Word[0x80006f68]
           1031000                                              #; (lsu) t0  <-- 2
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:821)
#;     uint32_t C = l->CI;
           1032000    0x800020d8 lw      s2, 0(t3)              #; t3  = 0x80006f60, s2  <~~ Word[0x80006f60]
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:875)
#;     snrt_mcycle (riscv.h:17)
#;       asm volatile("csrr %0, mcycle" : "=r"(r) : : "memory");
           1033000    0x800020dc csrr    a1, mcycle             #; mcycle = 1029, (wrb) a1  <-- 1029
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:815)
#;     snrt_cluster_core_idx (team.h:41)
#;       return snrt_global_core_idx() % snrt_cluster_core_num();
           1034000    0x800020e0 sub     s4, t2, a0             #; t2  = 4, a0  = 0, (wrb) s4  <-- 4
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:815)
#;     snrt_cluster_core_idx (team.h:-1)
#; 
           1035000    0x800020e4 li      a0, 8                  #; (wrb) a0  <-- 8
           1080000                                              #; (lsu) s2  <-- 4
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:835)
#;     ptr += C;
           1081000    0x800020e8 slli    a4, s2, 3              #; s2  = 4, (wrb) a4  <-- 32
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:876)
#;     if (snrt_is_dm_core()) {
           1082000    0x800020ec bgeu    s4, a0, pc + 340       #; s4  = 4, a0  = 8, not taken
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:-1)
#; 
...
#;       write_ssr_cfg (ssr.h:68)
#;         asm volatile("scfgwi %[value], %[dm] | %[reg]<<5\n" ::[value] "r"(value),
           1090000    0x8000210c scfgwi  a2, 223                #; a2  = 64
#; main (main.c:10)
