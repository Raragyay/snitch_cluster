#; unknown function (??:0)
#; 
             31000    0x00001000 csrr    a0, mhartid            #; mhartid = 6, (wrb) a0  <-- 6
             55000    0x00001004 auipc   a1, 0x0                #; (wrb) a1  <-- 4100
             79000    0x00001008 addi    a1, a1, 32             #; a1  = 4100, (wrb) a1  <-- 4132
            103000    0x0000100c auipc   t0, 0x0                #; (wrb) t0  <-- 4108
            127000    0x00001010 lw      t0, 20(t0)             #; t0  = 4108, t0  <~~ Word[0x00001020]
            152000                                              #; (lsu) t0  <-- 0x80000000
            153000    0x00001014 jalr    t0                     #; t0  = 0x80000000, (wrb) ra  <-- 4120, goto 0x80000000
#; unknown function (start.S:12)
#;   mv t0, x0
            160000    0x80000000 li      t0, 0                  #; (wrb) t0  <-- 0
#; unknown function (start.S:13)
#;   mv t1, x0
            161000    0x80000004 li      t1, 0                  #; (wrb) t1  <-- 0
#; unknown function (start.S:14)
#;   mv t2, x0
            162000    0x80000008 li      t2, 0                  #; (wrb) t2  <-- 0
#; unknown function (start.S:15)
#;   mv t3, x0
            163000    0x8000000c li      t3, 0                  #; (wrb) t3  <-- 0
#; unknown function (start.S:16)
#;   mv t4, x0
            164000    0x80000010 li      t4, 0                  #; (wrb) t4  <-- 0
#; unknown function (start.S:17)
#;   mv t5, x0
            165000    0x80000014 li      t5, 0                  #; (wrb) t5  <-- 0
#; unknown function (start.S:18)
#;   mv t6, x0
            166000    0x80000018 li      t6, 0                  #; (wrb) t6  <-- 0
#; unknown function (start.S:19)
#;   mv a0, x0
            167000    0x8000001c li      a0, 0                  #; (wrb) a0  <-- 0
#; unknown function (start.S:20)
#;   mv a1, x0
            168000    0x80000020 li      a1, 0                  #; (wrb) a1  <-- 0
#; unknown function (start.S:21)
#;   mv a2, x0
            169000    0x80000024 li      a2, 0                  #; (wrb) a2  <-- 0
#; unknown function (start.S:22)
#;   mv a3, x0
            170000    0x80000028 li      a3, 0                  #; (wrb) a3  <-- 0
#; unknown function (start.S:23)
#;   mv a4, x0
            171000    0x8000002c li      a4, 0                  #; (wrb) a4  <-- 0
#; unknown function (start.S:24)
#;   mv a5, x0
            172000    0x80000030 li      a5, 0                  #; (wrb) a5  <-- 0
#; unknown function (start.S:25)
#;   mv a6, x0
            173000    0x80000034 li      a6, 0                  #; (wrb) a6  <-- 0
#; unknown function (start.S:26)
#;   mv a7, x0
            174000    0x80000038 li      a7, 0                  #; (wrb) a7  <-- 0
#; unknown function (start.S:27)
#;   mv s0, x0
            175000    0x8000003c li      s0, 0                  #; (wrb) s0  <-- 0
...
#;   mul  t0, t1, t0
            268000    0x80000120 mul     t0, t1, t0             #; t1  = 0, t0  = 0
            286000                                              #; (acc) a0  <-- 6
            298000                                              #; (acc) t0  <-- 0
#; unknown function (start.S:111)
#;   add  a2, a2, t0
            299000    0x80000124 add     a2, a2, t0             #; a2  = 0x10000000, t0  = 0, (wrb) a2  <-- 0x10000000
#; unknown function (start.S:114)
#;   li   t0, SNRT_TCDM_SIZE
            300000    0x80000128 lui     t0, 0x20               #; (wrb) t0  <-- 0x00020000
#; unknown function (start.S:115)
#;   add  a2, a2, t0
            301000    0x8000012c add     a2, a2, t0             #; a2  = 0x10000000, t0  = 0x00020000, (wrb) a2  <-- 0x10020000
#; unknown function (start.S:121)
#;   la        t0, __cdata_end
            302000    0x80000130 auipc   t0, 0x7                #; (wrb) t0  <-- 0x80007130
            303000    0x80000134 addi    t0, t0, -1176          #; t0  = 0x80007130, (wrb) t0  <-- 0x80006c98
#; unknown function (start.S:122)
#;   la        t1, __cdata_start
            304000    0x80000138 auipc   t1, 0x7                #; (wrb) t1  <-- 0x80007138
            305000    0x8000013c addi    t1, t1, -1184          #; t1  = 0x80007138, (wrb) t1  <-- 0x80006c98
#; unknown function (start.S:123)
#;   sub       t0, t0, t1
            306000    0x80000140 sub     t0, t0, t1             #; t0  = 0x80006c98, t1  = 0x80006c98, (wrb) t0  <-- 0
#; unknown function (start.S:124)
#;   sub       a2, a2, t0
            307000    0x80000144 sub     a2, a2, t0             #; a2  = 0x10020000, t0  = 0, (wrb) a2  <-- 0x10020000
#; unknown function (start.S:125)
#;   la        t0, __cbss_end
            308000    0x80000148 auipc   t0, 0x7                #; (wrb) t0  <-- 0x80007148
            309000    0x8000014c addi    t0, t0, -1184          #; t0  = 0x80007148, (wrb) t0  <-- 0x80006ca8
#; unknown function (start.S:126)
#;   la        t1, __cbss_start
            310000    0x80000150 auipc   t1, 0x7                #; (wrb) t1  <-- 0x80007150
            311000    0x80000154 addi    t1, t1, -1208          #; t1  = 0x80007150, (wrb) t1  <-- 0x80006c98
#; unknown function (start.S:127)
#;   sub       t0, t0, t1
            312000    0x80000158 sub     t0, t0, t1             #; t0  = 0x80006ca8, t1  = 0x80006c98, (wrb) t0  <-- 16
#; unknown function (start.S:128)
#;   sub       a2, a2, t0
            313000    0x8000015c sub     a2, a2, t0             #; a2  = 0x10020000, t0  = 16, (wrb) a2  <-- 0x1001fff0
#; unknown function (start.S:135)
#;   addi      a2, a2, -8
            314000    0x80000160 addi    a2, a2, -8             #; a2  = 0x1001fff0, (wrb) a2  <-- 0x1001ffe8
#; unknown function (start.S:136)
#;   sw        zero, 0(a2)
            315000    0x80000164 sw      zero, 0(a2)            #; a2  = 0x1001ffe8, 0 ~~> Word[0x1001ffe8]
#; unknown function (start.S:140)
#;   sll       t0, a0, SNRT_LOG2_STACK_SIZE
            316000    0x80000168 slli    t0, a0, 10             #; a0  = 6, (wrb) t0  <-- 6144
#; unknown function (start.S:143)
#;   sub       sp, a2, t0
            317000    0x8000016c sub     sp, a2, t0             #; a2  = 0x1001ffe8, t0  = 6144, (wrb) sp  <-- 0x1001e7e8
#; unknown function (start.S:147)
#;   sll       t1, a1, t2
            318000    0x80000170 sll     t1, a1, t2             #; a1  = 9, t2  = 0, (wrb) t1  <-- 9
#; unknown function (start.S:148)
#;   sub       a2, a2, t1
            319000    0x80000174 sub     a2, a2, t1             #; a2  = 0x1001ffe8, t1  = 9, (wrb) a2  <-- 0x1001ffdf
#; unknown function (start.S:151)
#;   slli      t0, a0, 3  # this hart
            320000    0x80000178 slli    t0, a0, 3              #; a0  = 6, (wrb) t0  <-- 48
#; unknown function (start.S:152)
#;   slli      t1, a1, 3  # all harts
            321000    0x8000017c slli    t1, a1, 3              #; a1  = 9, (wrb) t1  <-- 72
#; unknown function (start.S:153)
#;   sub       sp, sp, t0
            324000    0x80000180 sub     sp, sp, t0             #; sp  = 0x1001e7e8, t0  = 48, (wrb) sp  <-- 0x1001e7b8
...
#;   sub       sp, sp, t0
            331000    0x8000019c sub     sp, sp, t0             #; sp  = 0x1001e7b8, t0  = 0, (wrb) sp  <-- 0x1001e7b8
...
#;   sub       sp, sp, t0
            341000    0x800001b4 sub     sp, sp, t0             #; sp  = 0x1001e7b8, t0  = 16, (wrb) sp  <-- 0x1001e7a8
#; unknown function (start.S:168)
#;   andi      sp, sp, ~0x7 # align to 8B
            342000    0x800001b8 andi    sp, sp, -8             #; sp  = 0x1001e7a8, (wrb) sp  <-- 0x1001e7a8
#; unknown function (start.S:170)
#;   mv        tp, sp
            343000    0x800001bc mv      tp, sp                 #; sp  = 0x1001e7a8, (wrb) tp  <-- 0x1001e7a8
#; unknown function (start.S:172)
#;   andi      sp, sp, ~0x7 # align stack to 8B
            348000    0x800001c0 andi    sp, sp, -8             #; sp  = 0x1001e7a8, (wrb) sp  <-- 0x1001e7a8
...
#;   void snrt_main() {
            362000    0x80005ea8 addi    sp, sp, -32            #; sp  = 0x1001e7a8, (wrb) sp  <-- 0x1001e788
#; snrt_main (start.c:-1)
#; 
            363000    0x80005eac sw      ra, 28(sp)             #; sp  = 0x1001e788, 0x800001cc ~~> Word[0x1001e7a4]
            364000    0x80005eb0 sw      s0, 24(sp)             #; sp  = 0x1001e788, 0 ~~> Word[0x1001e7a0]
            365000    0x80005eb4 sw      s1, 20(sp)             #; sp  = 0x1001e788, 0 ~~> Word[0x1001e79c]
            366000    0x80005eb8 sw      s2, 16(sp)             #; sp  = 0x1001e788, 0 ~~> Word[0x1001e798]
...
#;               asm("csrr %0, mhartid" : "=r"(hartid));
            367000    0x80005ebc csrr    s2, mhartid            #; mhartid = 6, (wrb) s2  <-- 6
#; snrt_main (start.c:114)
#;   snrt_init_tls (start.c:29)
#;     snrt_is_dm_core (team.h:57)
#;       snrt_is_compute_core (team.h:53)
...
#;           return snrt_global_core_idx() % snrt_cluster_core_num();
            376000    0x80005ec8 mulhu   a0, s2, a0             #; s2  = 6, a0  = 0x38e38e39
            386000                                              #; (acc) a0  <-- 1
            387000    0x80005ecc srli    a0, a0, 1              #; a0  = 1, (wrb) a0  <-- 0
            388000    0x80005ed0 slli    a1, a0, 3              #; a0  = 0, (wrb) a1  <-- 0
            389000    0x80005ed4 add     a0, a1, a0             #; a1  = 0, a0  = 0, (wrb) a0  <-- 0
            390000    0x80005ed8 sub     a5, s2, a0             #; s2  = 6, a0  = 0, (wrb) a5  <-- 6
            391000    0x80005edc li      a6, 8                  #; (wrb) a6  <-- 8
#; snrt_main (start.c:114)
#;   snrt_init_tls (start.c:29)
#;     if (snrt_is_dm_core()) {
            392000    0x80005ee0 bltu    a5, a6, pc + 524       #; a5  = 6, a6  = 8, taken, goto 0x800060ec
#; snrt_main (start.c:114)
...
#; 
            744000    0x800060f0 sltiu   a7, a5, 8              #; a5  = 6, (wrb) a7  <-- 1
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     if (snrt_cluster_idx() == 0 && snrt_is_dm_core()) {
            745000    0x800060f4 bltu    a6, s2, pc + 96        #; a6  = 8, s2  = 6, not taken
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     snrt_is_dm_core (team.h:57)
#;       snrt_is_compute_core (team.h:53)
#;         snrt_cluster_core_idx (team.h:41)
#;           return snrt_global_core_idx() % snrt_cluster_core_num();
            746000    0x800060f8 andi    a0, s2, 255            #; s2  = 6, (wrb) a0  <-- 6
            747000    0x800060fc lui     a1, 0x38e39            #; (wrb) a1  <-- 0x38e39000
            748000    0x80006100 addi    a1, a1, -455           #; a1  = 0x38e39000, (wrb) a1  <-- 0x38e38e39
            749000    0x80006104 mulhu   a1, a0, a1             #; a0  = 6, a1  = 0x38e38e39
            760000                                              #; (acc) a1  <-- 1
            761000    0x80006108 srli    a1, a1, 1              #; a1  = 1, (wrb) a1  <-- 0
            762000    0x8000610c slli    a2, a1, 3              #; a1  = 0, (wrb) a2  <-- 0
            763000    0x80006110 add     a1, a2, a1             #; a2  = 0, a1  = 0, (wrb) a1  <-- 0
            764000    0x80006114 sub     a0, a0, a1             #; a0  = 6, a1  = 0, (wrb) a0  <-- 6
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     snrt_is_dm_core (team.h:57)
#;       snrt_is_compute_core (team.h:53)
#;         return snrt_cluster_core_idx() < snrt_cluster_compute_core_num();
            765000    0x80006118 sltiu   a1, a0, 8              #; a0  = 6, (wrb) a1  <-- 1
#; snrt_main (start.c:122)
#;   snrt_init_bss (start.c:63)
#;     if (snrt_cluster_idx() == 0 && snrt_is_dm_core()) {
            766000    0x8000611c auipc   a0, 0x1                #; (wrb) a0  <-- 0x8000711c
            767000    0x80006120 addi    a0, a0, -292           #; a0  = 0x8000711c, (wrb) a0  <-- 0x80006ff8
            768000    0x80006124 auipc   a2, 0x1                #; (wrb) a2  <-- 0x80007124
            769000    0x80006128 addi    a2, a2, 512            #; a2  = 0x80007124, (wrb) a2  <-- 0x80007324
            770000    0x8000612c sub     a4, a2, a0             #; a2  = 0x80007324, a0  = 0x80006ff8, (wrb) a4  <-- 812
            771000    0x80006130 seqz    a2, a4                 #; a4  = 812, (wrb) a2  <-- 0
            772000    0x80006134 or      a1, a1, a2             #; a1  = 1, a2  = 0, (wrb) a1  <-- 1
            773000    0x80006138 bnez    a1, pc + 28            #; a1  = 1, taken, goto 0x80006154
#; snrt_main (start.c:130)
#;   snrt_init_cls (start.c:76)
#;     _cls_ptr = (cls_t*)snrt_cls_base_addr();
            774000    0x80006154 auipc   a5, 0x1                #; (wrb) a5  <-- 0x80007154
            775000    0x80006158 addi    a5, a5, -1212          #; a5  = 0x80007154, (wrb) a5  <-- 0x80006c98
            776000    0x8000615c auipc   t0, 0x1                #; (wrb) t0  <-- 0x8000715c
...
#;     _cls_ptr = (cls_t*)snrt_cls_base_addr();
            ...
            799000    0x8000618c add     a2, a2, tp             #; a2  = 0, tp  = 0x1001e7a8, (wrb) a2  <-- 0x1001e7a8
            800000    0x80006190 sw      a1, 0(a2)              #; a2  = 0x1001e7a8, 0x1001fff0 ~~> Word[0x1001e7a8]
#; snrt_main (start.c:130)
...
#; main (main.c:9)
#;   int main() {
            911000    0x80002084 addi    sp, sp, -48            #; sp  = 0x1001e788, (wrb) sp  <-- 0x1001e758
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:-1)
#; 
            912000    0x80002088 sw      s0, 44(sp)             #; sp  = 0x1001e758, 0x80006ca8 ~~> Word[0x1001e784]
            913000    0x8000208c sw      s1, 40(sp)             #; sp  = 0x1001e758, 0x80006c98 ~~> Word[0x1001e780]
            914000    0x80002090 sw      s2, 36(sp)             #; sp  = 0x1001e758, 6 ~~> Word[0x1001e77c]
            915000    0x80002094 sw      s3, 32(sp)             #; sp  = 0x1001e758, 0 ~~> Word[0x1001e778]
            916000    0x80002098 sw      s4, 28(sp)             #; sp  = 0x1001e758, 0 ~~> Word[0x1001e774]
            917000    0x8000209c sw      s5, 24(sp)             #; sp  = 0x1001e758, 0 ~~> Word[0x1001e770]
            923000    0x800020a0 sw      s6, 20(sp)             #; sp  = 0x1001e758, 0 ~~> Word[0x1001e76c]
            924000    0x800020a4 sw      s7, 16(sp)             #; sp  = 0x1001e758, 0 ~~> Word[0x1001e768]
            925000    0x800020a8 sw      s8, 12(sp)             #; sp  = 0x1001e758, 0 ~~> Word[0x1001e764]
#; main (main.c:10)
...
#;         snrt_hartid (team.h:7)
#;           asm("csrr %0, mhartid" : "=r"(hartid));
            926000    0x800020ac csrr    t2, mhartid            #; mhartid = 6, (wrb) t2  <-- 6
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:815)
#;     snrt_cluster_core_idx (team.h:41)
#;       snrt_global_core_idx (team.h:28)
...
#;     snrt_cluster_core_idx (team.h:41)
#;       return snrt_global_core_idx() % snrt_cluster_core_num();
            929000    0x800020b8 mulhu   a0, t2, a0             #; t2  = 6, a0  = 0x38e38e39
            932000                                              #; (acc) a0  <-- 1
            933000    0x800020bc srli    a0, a0, 1              #; a0  = 1, (wrb) a0  <-- 0
...
#;     uint32_t W = l->IW;
            951000    0x800020d4 lw      t0, 8(t3)              #; t3  = 0x80006f60, t0  <~~ Word[0x80006f68]
           1000000                                              #; (lsu) t0  <-- 2
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:821)
#;     uint32_t C = l->CI;
           1001000    0x800020d8 lw      s2, 0(t3)              #; t3  = 0x80006f60, s2  <~~ Word[0x80006f60]
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:875)
#;     snrt_mcycle (riscv.h:17)
#;       asm volatile("csrr %0, mcycle" : "=r"(r) : : "memory");
           1002000    0x800020dc csrr    a1, mcycle             #; mcycle = 998, (wrb) a1  <-- 998
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:815)
#;     snrt_cluster_core_idx (team.h:41)
#;       return snrt_global_core_idx() % snrt_cluster_core_num();
           1003000    0x800020e0 sub     s4, t2, a0             #; t2  = 6, a0  = 0, (wrb) s4  <-- 6
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:815)
#;     snrt_cluster_core_idx (team.h:-1)
#; 
           1004000    0x800020e4 li      a0, 8                  #; (wrb) a0  <-- 8
           1041000                                              #; (lsu) s2  <-- 4
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:835)
#;     ptr += C;
           1042000    0x800020e8 slli    a4, s2, 3              #; s2  = 4, (wrb) a4  <-- 32
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:876)
#;     if (snrt_is_dm_core()) {
           1043000    0x800020ec bgeu    s4, a0, pc + 340       #; s4  = 6, a0  = 8, not taken
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:-1)
#; 
           1044000    0x800020f0 srli    a0, s2, 3              #; s2  = 4, (wrb) a0  <-- 0
           1045000    0x800020f4 andi    a1, s2, 7              #; s2  = 4, (wrb) a1  <-- 4
           1046000    0x800020f8 sltu    a1, s4, a1             #; s4  = 6, a1  = 4, (wrb) a1  <-- 0
           1047000    0x800020fc add     a0, a0, a1             #; a0  = 0, a1  = 0, (wrb) a0  <-- 0
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:882)
#;     snrt_ssr_loop_1d (ssr.h:74)
#;       --b0;
           1048000    0x80002100 addi    a1, a0, -1             #; a0  = 0, (wrb) a1  <-- -1
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:882)
#;     snrt_ssr_loop_1d (ssr.h:75)
#;       write_ssr_cfg (ssr.h:68)
#;         asm volatile("scfgwi %[value], %[dm] | %[reg]<<5\n" ::[value] "r"(value),
           1049000    0x80002104 scfgwi  a1, 95                 #; a1  = -1
           1050000    0x80002108 li      a2, 64                 #; (wrb) a2  <-- 64
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:882)
#;     snrt_ssr_loop_1d (ssr.h:77)
#;       write_ssr_cfg (ssr.h:68)
#;         asm volatile("scfgwi %[value], %[dm] | %[reg]<<5\n" ::[value] "r"(value),
           1051000    0x8000210c scfgwi  a2, 223                #; a2  = 64
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:885)
#;     snrt_mcycle (riscv.h:17)
#;       asm volatile("csrr %0, mcycle" : "=r"(r) : : "memory");
           1052000    0x80002110 csrr    a2, mcycle             #; mcycle = 1048, (wrb) a2  <-- 1048
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:886)
#;     snrt_cluster_hw_barrier();
           1053000    0x80002114 csrwi   unknown_7c3, 0         #; 
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:887)
#;     snrt_cluster_hw_barrier (sync.h:59)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
           1054000    0x80002118 csrs    unknown_7c2, zero      #; csr@7c2 = 0
#; main (main.c:10)
...
#;     snrt_cluster_hw_barrier (sync.h:59)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
           1196000    0x800025cc csrs    unknown_7c2, zero      #; csr@7c2 = 0
#; main (main.c:14)
#;   return 0;
           1285000    0x800025d0 li      a0, 0                  #; (wrb) a0  <-- 0
           1286000    0x800025d4 lw      s8, 12(sp)             #; sp  = 0x1001e758, s8  <~~ Word[0x1001e764]
           1289000                                              #; (lsu) s8  <-- 0
           1290000    0x800025d8 lw      s7, 16(sp)             #; sp  = 0x1001e758, s7  <~~ Word[0x1001e768]
           1293000                                              #; (lsu) s7  <-- 0
           1294000    0x800025dc lw      s6, 20(sp)             #; sp  = 0x1001e758, s6  <~~ Word[0x1001e76c]
           1297000                                              #; (lsu) s6  <-- 0
           1298000    0x800025e0 lw      s5, 24(sp)             #; sp  = 0x1001e758, s5  <~~ Word[0x1001e770]
           1301000                                              #; (lsu) s5  <-- 0
           1302000    0x800025e4 lw      s4, 28(sp)             #; sp  = 0x1001e758, s4  <~~ Word[0x1001e774]
           1305000                                              #; (lsu) s4  <-- 0
           1306000    0x800025e8 lw      s3, 32(sp)             #; sp  = 0x1001e758, s3  <~~ Word[0x1001e778]
           1309000                                              #; (lsu) s3  <-- 0
           1310000    0x800025ec lw      s2, 36(sp)             #; sp  = 0x1001e758, s2  <~~ Word[0x1001e77c]
           1313000                                              #; (lsu) s2  <-- 6
           1314000    0x800025f0 lw      s1, 40(sp)             #; sp  = 0x1001e758, s1  <~~ Word[0x1001e780]
