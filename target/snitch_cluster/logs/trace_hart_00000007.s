...
#;     snrt_cluster_hw_barrier (sync.h:59)
#;       asm volatile("csrr x0, 0x7C2" ::: "memory");
           1062000    0x80002114 csrs    unknown_7c2, zero      #; csr@7c2 = 0
#; main (main.c:10)
...
#; 
           ...
           1191000    0x80002124 slli    t1, s4, 3              #; s4  = 7, (wrb) t1  <-- 56
#; main (main.c:10)
...
#;     for (uint32_t channel = compute_id; channel < C; channel += num_compute_cores) {
           1302000    0x80002190 sltu    a6, s4, s2             #; s4  = 7, s2  = 4, (wrb) a6  <-- 0
           1303000    0x80002194 bgeu    s4, s2, pc + 208       #; s4  = 7, s2  = 4, taken, goto 0x80002264
           1306000                                              #; (acc) t6  <-- 4
#; main (main.c:10)
#;   batchnorm_backward_training (batchnorm.h:938)
#;     DUMP(1);
           1308000    0x80002264 csrwi   unknown_7c3, 1         #; 
